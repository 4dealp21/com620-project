...
AFRAME.registerComponent('entity-downloader',  {
    ...
    init: function () {
        ...
        navigator.geolocation.getCurrentPosition( async(gpspos) => {
            ...
            // Get the pois
            const response = await fetch(`https://hikar.org/webapp/map/all?bbox=${gpspos.coords.longitude-0.55},${gpspos.coords.latitude-0.25},${gpspos.coords.longitude+0.55},${gpspos.coords.latitude+0.25}`);
